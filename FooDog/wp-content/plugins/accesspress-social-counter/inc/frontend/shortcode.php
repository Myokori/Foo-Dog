                    ...
                    switch ( $social_profile ) {
                         case 'facebook':
                              ...
                              <a  class="apsc-facebook-icon clearfix" href="<?php echo "https://facebook.com/" . $facebook_page_id; ?>" target="_blank" <?php do_action( 'apsc_facebook_link' ); ?>>
                                   <div class="apsc-inner-block">
                                        <span class="social-icon"><i class="fa fa-facebook apsc-facebook"></i></span>
                                        <span class="apsc-count"><?php echo $count; ?></span><span class="media-name">Fans</span><span class="apsc-media-type">Fans</span><span class="media-tag-like">Like</span>
                                   </div>
                              </a>
                              <?php
                              break;
                         case 'twitter':
                              ...
                              <a  class="apsc-twitter-icon clearfix"  href="<?php echo 'https://twitter.com/' . $apsc_settings[ 'social_profile' ][ 'twitter' ][ 'username' ]; ?>" target="_blank"  <?php do_action( 'apsc_twitter_link' ); ?>>
                                   <div class="apsc-inner-block">
                                        <span class="social-icon"><i class="fa fa-twitter apsc-twitter"></i></span>
                                        <span class="apsc-count"><?php echo $count; ?></span><span class="media-name">Followers</span><span class="apsc-media-type">Followers</span><span class="media-tag-follow">Follow</span>
                                   </div>
                              </a>
                              <?php
                              break;
                         ...
                         case 'instagram':
                              ...
                              <a  class="apsc-instagram-icon clearfix" href="<?php echo $social_profile_url; ?>" target="_blank"   <?php do_action( 'apsc_instagram_link' ); ?>>
                                   <div class="apsc-inner-block">
                                        <span class="social-icon"><i class="apsc-instagram fa fa-instagram"></i></span>
                                        <span class="apsc-count"><?php echo $count; ?></span><span class="media-name">Followers</span><span class="apsc-media-type">Followers</span><span class="media-tag-follow">Follow</span>
                                   </div>
                              </a>
                              <?php
